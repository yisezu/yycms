...
layui.define(['code', 'element', 'table', 'util', 'carousel', 'laytpl'], function(exports){
  ...
  ;!function(){
    var elemComponentSelect = $(['<select lay-search lay-filter="component">'
      ...
      ,'<option value="/layui/layim/index.html">layim</option>'
      ,'<option value="/layui/layuiadmin/index.html">layuiadmin</option>'
    ,'</select>'
  ...
  ;!function(){
    ...
    })([{"classname":"toptg","key":"toptg-notice","title":"关于本站","url":layui.cache.dir + "../../../about/notice.html","CONFIG_TIME":"9/26/2021, 6:25:48 PM","tips":"","tipsCss":"background-image: linear-gradient(to right,#359FD4,#36B5C8,#25D8AB","hot":"1"}]);
  }();
