  ...
  <?php include('../admin_config/admin_list.php');?>
		...
		<div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">每日弹窗广告</i></div>
		...
		?>				
				...
				<form method="post"  class="layui-form">
				    ...
				    <input type="hidden" name="ad_top_pic"  value="null" />
...
window.location.href="ad_Popup.php" 
