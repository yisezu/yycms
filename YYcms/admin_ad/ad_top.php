		...
		<div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">头部横幅广告</i></div>
		      <div style="padding: 30px;">
		          
		   
		     <a href="ad_top_add.php"><button type="button" class="layui-btn layui-btn-primary layui-border-green"><span class="am-icon-plus"></span> 新增</button></a>
			...
			<div  class="layui-colla-content1 show1">
			  ...
			  if(isset($_GET['id'])){
			      ...
			      exit('<script>layer.msg("删除成功！");location.href="ad_top.php";</script>');
			  }
			  $json = jsonsort($json);
			  ...
			  ?>
			    <tr>
			        ...
			        <td><a href="ad_top_mod.php?id=<?php echo $item['id'];?>" > 编辑</a><a href="?id=<?php echo $item['id'];?>" > 删除</a></td>
			    </tr>
			  <?php	
			  } 
			  ?>	
