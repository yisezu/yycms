		...
		<div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">底部浮漂广告</i></div>
		  ...
		  ?>
		    <tr>
		        ...
		        <td><a href="ad_float_mod.php?id=<?php echo $ad_top_id?>" >编辑</a></td>    
		    </tr>                                        
		  <?php	
		  } 
		  ?>	
