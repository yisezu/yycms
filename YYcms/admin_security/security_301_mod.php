        ...
        <div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">301修改</i></div>
		      <div style="padding: 30px;">
				  <?php
				  $ad_top_json_url=YYCMS_ROOT."Basicsetup/ad.json";
				...
				<form method="post"  class="layui-form">
				    ...
				    <div class="layui-form-item">
				      <label class="layui-form-label">重定向状态</label>
				      <div class="layui-input-block">
				        <select name="ad_top_url_zt" lay-verify="required">
					...
					<div class="layui-form-item">
					  ...
					  <div class="layui-input-block">
					    <input type="text" name="ad_top_md" required  lay-verify="required" value="<?php echo  $ad_top_md;?>" placeholder="请输入备注" autocomplete="off" class="layui-input">
					  </div>
					</div>
