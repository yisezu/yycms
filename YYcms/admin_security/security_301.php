		...
		<div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">301重定向</i></div>
      		  ...
      		  ?>
      		                                          <tr>
      		                                              ...
      		                                              <td>
      		                                                  <div >
      		                                                      <div>
      		                                                          <a href="security_301_mod.php?id=<?php echo $ad_top_id?>"> 编辑</a>
      		                                                      </div>
      		                                                  </div>
      		                                              </td>
      		                                          </tr>
