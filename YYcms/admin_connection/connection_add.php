		...
		<div class="layui-row layui-col-space15">
			  <div class="layui-col-md">
			    <div class="layui-panel">
			        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">友情链接添加</i></div>
			      <div style="padding: 30px;">
					  ...
					  if(isset($_POST['title'])){
					      ...
					      exit('<script>layer.msg("添加成功！");location.href="connection.php";</script>');
					  }
					...
					<form method="post"  class="layui-form">
					    ...
					    <div class="layui-form-item">
					      ...
					      <div class="layui-input-block">
					        <input type="text" name="sort" required  lay-verify="required" value="" placeholder="请输入URL" autocomplete="off" class="layui-input">
					      </div>
					    </div>
						...
						<div class="layui-form-item">
						  ...
						  <div class="layui-input-block">
						    <input type="text" name="title" required  lay-verify="required" value="" placeholder="请输入友链标题" autocomplete="off" class="layui-input">
						  </div>
						</div>
						...
						<div class="layui-form-item">
						  ...
						  <div class="layui-input-block">
						    <input type="text" name="url" required  lay-verify="required" value="" placeholder="请输入友链地址URL" autocomplete="off" class="layui-input">
						...
						<div class="layui-form-item">
						  ...
						  <div class="layui-input-block">
						    <input type="text" name="remark" required  lay-verify="required" value="" placeholder="如12/8~1/8广告费100元" autocomplete="off" class="layui-input">
						  </div>
						</div>
