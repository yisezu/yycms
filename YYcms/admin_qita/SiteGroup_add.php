...
<script src="<?php echo YYCMS_ADMIN_url;?>assets/js/keywords.js"></script>
  </head>
...
<![endif]--> 
  ...
  <?php include('../admin_config/admin_list.php');?>
		...
		<div class="layui-row layui-col-space15">
		  <div class="layui-col-md">
		    <div class="layui-panel">
		        <div class="layui-card-header"><i class="layui-icon layui-icon-note" style="font-size: 20px; ">站群域名添加</i></div>
        ...
        if(isset($_POST['domains'])){
            ...
            exit('<script>layer.msg("恭喜添加成功");window.setTimeout(function () {window.location.reload(history.go(-2));},2000);</script>');
        }
        ?>
		<form method="post"  >
		    ...
		    <div class="layui-form-item">
		      ...
		      <div class="layui-input-block">
		        <input type="text" name="domains" required  lay-verify="required" placeholder="网站域名不带前缀如www.baidu.com填写baidu.com即可,多个域名用|分隔" autocomplete="off" class="layui-input" value="">
		      </div>
		    </div>
		    <div class="layui-form-item">
		      <label class="layui-form-label">名称</label>
		      <div class="layui-input-block">
		        <input type="text" name="title" required  lay-verify="required" value="" placeholder="请输入网站名称" autocomplete="off" class="layui-input">
		      </div>
		    </div>
			<div class="layui-form-item">
			  <label class="layui-form-label">关键字</label>
			  <div class="layui-input-block">
			    <input type="text" name="keywords" required  lay-verify="required" value="" placeholder="请输入关键字" autocomplete="off" class="layui-input">
			...
			<div class="layui-form-item">
			  ...
			  <div class="layui-input-block">
			    <input type="text" name="description" value="" required  lay-verify="required"  placeholder="请输入关键描述" autocomplete="off" class="layui-input">
			  </div>
			</div>
		    ...
		    <div class="layui-form-item layui-form-text">
		      ...
		      <div class="layui-input-block">
				<input type="text" name="logo" value="<?php echo $site_config['logo'];?>" required  lay-verify="required"  placeholder="请输入网站logoURL" autocomplete="off" class="layui-input">
		      </div>
		    </div>
			<div class="layui-form-item layui-form-text">
			  <label class="layui-form-label">邮箱</label>
			  <div class="layui-input-block">
				<input type="email" name="email" value="<?php echo $site_config['email'];?>" required  lay-verify="required"  placeholder="请输入广告邮箱" autocomplete="off" class="layui-input">
			</div>
		    <div class="layui-form-item">
		      <div class="layui-input-block">
